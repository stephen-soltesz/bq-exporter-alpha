...
WHERE
    TIMESTAMP_TO_USEC(log_time) > INTEGER(TIMESTAMP_TO_USEC(CURRENT_TIMESTAMP()) / (15 * 60 * 1000000)) * (15 * 60 * 1000000) - (24 * 60 * 60 * 1000000)
AND TIMESTAMP_TO_USEC(log_time) < INTEGER(TIMESTAMP_TO_USEC(CURRENT_TIMESTAMP()) / (15 * 60 * 1000000)) * (15 * 60 * 1000000) - (24 * 60 * 60 * 1000000) + (15 * 60 * 1000000)
